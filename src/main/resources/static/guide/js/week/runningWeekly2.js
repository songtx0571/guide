...
function change(){
	...
	$.ajax({ 
		...
		"success":function(Json){
			var data = Json.data;
			console.log(data);
			sessionStorage.runningWeeklyFillIn = data.fillIn;
			sessionStorage.runningWeeklyAuditor = data.auditor;
			...
			sessionStorage.runningWeekId = data.id;
		},
		"error":function(){
			layer.alert("系统繁忙");
		}	
...
function addFillIn(){
	...
	/*$.ajax({
		...
		"data":{userName:userName,projectId:projectId,permissionId:55},
		"success":function(data){
			if(!data){
...
function delFillIn(index){
	...
	/*$.ajax({
		"type" : 'post', 
		"url": "/getPermissionByPermissionId",  
		"data":{userName:userName,projectId:projectId,permissionId:56},
		"success":function(data){
			if(!data){
...
function addAuditor(){
	...
	/*$.ajax({
		"type" : 'post', 
		"url": "/getPermissionByPermissionId",  
		"data":{userName:userName,projectId:projectId,permissionId:57},
		"success":function(data){
			if(!data){
				layer.alert('该账号没有添加的权限，请换账号重试!', {icon : 2});
				return;
...
function delAuditor(index){
	...
	/*$.ajax({
		"type" : 'post', 
		"url": "/getPermissionByPermissionId",  
		"data":{userName:userName,projectId:projectId,permissionId:58},
		"success":function(data){
			if(!data){
				layer.alert('该账号没有删除填写人的权限，请换账号重试!', {icon : 2});
				return;
