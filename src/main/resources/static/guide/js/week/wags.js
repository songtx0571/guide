...
function sumWages() {
    ...
    var subTotalOfSubsidies = $("#subTotalOfSubsidies").val();
    $("#totalPayable").val(Number(wagesPayable)+Number(subTotalOfSubsidies));
    //扣款合计
    ...
    $.ajax({
        ...
        data: {currentIncomeTax:$("#totalPayable").val(),other:$("#other").val(),deductionOfExpenses:'5000.00',employeeId:$("#userId").val(),month: $("#monthStart").val(),fiveInsurancesAndOneFund:$("#totalDeduction").val(),totalTax:$("#totalTax").val(),id:$("#wagsId").val(),specialAdditionalDeduction:$("#sixSpecialDeductions").val()},
        dataType: "json",
        success: function(data){
            var individualTaxAdjustment = data.tax;
            individualTaxAdjustment = individualTaxAdjustment.toFixed(2);
