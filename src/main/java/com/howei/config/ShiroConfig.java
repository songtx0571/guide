...
public class ShiroConfig {
    ...
    public DefaultWebSecurityManager securityManager(@Qualifier("loginRealm") LoginRealm loginRealm, DefaultWebSessionManager sessionManager, RedisCacheManager redisCacheManager) {
