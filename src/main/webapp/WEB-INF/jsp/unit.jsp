...
<head>
    ...
    <script type="text/javascript" src="../js/week/unit.js?version=1.03"></script>
</head>
<style type="text/css">
    .top{
        width: 100%;
    ...
    .addUnit,.addUnit table,.updUnit,.updUnit table{
        width: 400px;
    }
    .addUnit tr,.updUnit tr{
        line-height: 50px;
    }
    .addUnit tr td:first-of-type, .updUnit tr td:first-of-type{
        text-align: right;
        width: 128px;
    }
    .addUnit tr td input, .updUnit tr td input{
        width: 237px;
        height: 38px;
        border: 1px solid #e6e6e6;
    }
    .addUnit .layui-anim,.updUnit .layui-anim{
        height: 120px;
    }
...
<div class="warp">
        ...
        <form class="layui-form" action="" style="display: inline-block;">
            <div class="layui-form-item">
                <div class="layui-input-block" style="margin-left: 50px;margin-right: 50px;">
                    <button type="button" class="layui-btn" onclick="selShowUnitList()">查询</button>
                </div>
            </div>
        </form>
        <form class="layui-form" action="" style="display: inline-block;">
            <div class="layui-form-item" style="width: 300px;">
                <div class="">
                    <button type="button" class="layui-btn layui-btn-fluid  layui-btn-normal" onclick="openUnit()">创建</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="updUnit">
        <table cellspacing="0">
            <tr>
                <td>名称：</td>
                <td><input type="text" id="updUnitName"></td>
            </tr>
            <tr>
                <td>部门：</td>
                <td>
