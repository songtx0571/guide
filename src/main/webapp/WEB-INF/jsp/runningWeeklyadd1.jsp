...
<body>
	<div style="margin: auto;">
		...
		<table id='table' border="1" style="margin:auto;width:50%; rules:'all';border-collapse:collapse;">
			<tr> 
				<th colspan="2" th:if="${type} == 1">入口SO2浓度(mg/Nm³)</th>
				<th colspan="2" th:if="${type} == 2">入口NOX浓度(mg/Nm³)</th>
				<th colspan="2" th:if="${type} == 3">出口SO2浓度(mg/Nm³)</th>
				<th colspan="2" th:if="${type} == 4">出口NOX浓度(mg/Nm³)</th>
				<th colspan="2" th:if="${type} == 5">出口粉尘浓度(mg/Nm³)</th>
				<th colspan="2" th:if="${type} == 6">石灰石耗量(T)</th>
				<th colspan="2" th:if="${type} == 7">氨水耗量(T)</th>
			</tr>
			<tr>
				<th id='th1'>1#</th>
				<th>
