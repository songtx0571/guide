...
<div style="padding: 30px 30px 30px 30px;" hidden id="unitWin">
    <form method="poxt">
        <input type="text" hidden id="unitId"/>
            ...
            <tr>
                ...
                <td>
                    <select class="easyui-combobox" id="type" name="type"
                            data-options="required:false,width:'250px'">
                    </select>
                </td>--%>
            </tr>
        </table>
        <div style="text-align: center; padding: 5px;height: 80px;line-height: 80px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div style="height: 40px;width: 80px;border-radius: 5px;background-color: #00bbee;display: inline-block;line-height: 40px;" onclick="closeWin(addunitWin)">
