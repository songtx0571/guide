	...
	<div style="margin: auto;">
		...
		<table id='table' border="1" style="margin:auto;width:90%; rules:'all';border-collapse:collapse;">
			<tr>
				<th id='th1'>时间</th>
				<th>
					<input type="text" id="content1" th:value="${ScrDailyRecord.content1}" onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate"/>
				</th>
			</tr>
			<tr>
				<th id='th1'>内容</th>
				<th>
					<textarea id='content2' rows="5" cols="50" maxlength="100" th:text="${ScrDailyRecord.content2}"></textarea>
				</th>
			</tr>
			<tr>
