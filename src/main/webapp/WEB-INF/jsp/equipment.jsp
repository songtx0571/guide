...
<body class="easyui-layout">
    ...
    <%--<div id="equiBar" style="height: 100px;text-align: center;line-height: 100px;background-color: #00bbee;border-radius: 8px;" onclick="openEquipment()">--%>
        ...
        <%--</span>--%>
    <%--</div>--%>
    <div id="equiBar" style="width: 100%;height: 100px;text-align: center;padding: 25px 0px; box-sizing: border-box;">
        <div style="width: 70%;height: 50px;background-color: #00bbee;border-radius: 8px;line-height: 50px;margin-left: 15%;" onclick="openEquipment()">
        <span style="font-size: 20px;text-align: center;">
            <a href="javascript:openEquipment()" style="text-decoration: none;color: #fff"><strong>创建</strong></a>
        </span>
        </div>
    </div>
</body>
