...
<div style="padding: 30px 30px 30px 30px;" hidden id="system">
    <form method="poxt">
        <input type="text" hidden id="SystemId"/>
        <table style="border-collapse:separate; border-spacing:0px 20px;">
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" style="width:250px;" value="系统" readonly/>
                </td>
            </tr>
            <tr>
                <td>部门</td>
        ...
        <div style="text-align: center; padding: 5px;height: 80px;line-height: 80px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;
            <div style="height: 40px;width: 80px;border-radius: 5px;background-color: #00bbee;display: inline-block;line-height: 40px;" onclick="closeWin(addSystem)">
