...
<head>
    ...
    <script type="text/javascript" src="../js/week/runningWeekly2.js"></script>
...
<div>
		<span>
			...
			周选择:<input id="week" class="Wdate" type="text"
                       onfocus="WdatePicker({isShowWeek:true,onpicked:funccc,errDealMode:3,maxDate:'%y-%M-%d'})"/>
    ...
    <table style="width: 80%;margin-top: 50px;">
        ...
        <tr>
            <th>填写人</th>
            <td colspan="4" id='fillIn'></td>
            <th>批准人</th>
            <td colspan="3" id='auditor'></td>
        </tr>
        <tr>
            <th colspan="9">运行指标情况</th>
        </tr>
        <tr>
            <th>序号</th>
            <th colspan="7">内容</th>
        ...
        <thead>
        <tr>
            <th colspan="9">需要调节事项</th>
        </tr>
        <tr>
            <th colspan="9">一、采购方面</th>
        </tr>
        <tr>
            <th>序号</th>
            <th colspan="7">内容</th>
